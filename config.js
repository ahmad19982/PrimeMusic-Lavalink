...
module.exports = {
  TOKEN: "",
  ownerID: ["559843996856221736", ""], 
  setupFilePath: './commands/setup.json',
  commandsDir: './commands',  
  embedColor: "#1db954",
  musicardTheme:"themes16", //Goes from themes1 to themes19
  activityName: "TIGER", // This is bot status Write Anything here 
  activityType: "LISTENING",  // Available activity types : LISTENING , PLAYING , WATCHING
  SupportServer: "https://discord.gg/uCjmahY8hx",
